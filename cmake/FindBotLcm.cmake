...
find_library(LIBBOT_FRAMES_RENDERERS_LIBRARY bot2-frames-renderers PATHS ${_bot_lib_dir} DOC "The bot-frames library")
...
set(LIBBOT_LIBRARIES ${LIBBOT_CORE_LIBRARY} ${LIBBOT_FRAMES_LIBRARY} ${LIBBOT_FRAMES_RENDERERS_LIBRARY} ${LIBBOT_PARAM_CLIENT_LIBRARY} ${LIBBOT_LCMGL_CLIENT_LIBRARY} ${LIBBOT_LCMGL_RENDERER_LIBRARY} ${LIBBOT_VIS_LIBRARY} ${GTK2_GLIB_LIBRARY})

set(LCM_FOUND true)
set(LIBBOT_FOUND true)
